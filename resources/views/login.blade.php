            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="{{ route('loginproses') }}" novalidate>
                    @csrf
              ...
              <div class="credits text-sm-center">                
                &copy; <strong>Kalkulator Bank Sampah</strong>. All Rights Reserved
              </div>
